...
var MonthViewComponent = /** @class */ (function () {
    ...
    MonthViewComponent.prototype.countEvent = function (events) {
    ...
    MonthViewComponent = MonthViewComponent_1 = tslib_1.__decorate([
        Component({
            ...
            template: "\n <div>" +
                ...
                " tappable (click)=\"select(views[0].dates[row*7+col])\"\n " +
                ...
                + " <ion-badge *ngIf=\"views[0].dates[row*7+col].events.length > 0\">{{countEvent(views[0].dates[row*7+col].events)}}</ion-badge>\n" 
                + " </div>\n" 
                + "\n" 
                + "</td>\n" +
                " </tr>\n" +
